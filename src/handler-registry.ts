...
export class HandlerRegistry {
  ...
  // We're using 'any' here deliberately as the handlers are of heterogeneous types
  // with different parameter and return signatures, making a precise type definition
  // overly complex and likely to cause compatibility issues
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  // biome-ignore lint/suspicious/noExplicitAny: handlers are of heterogeneous types
